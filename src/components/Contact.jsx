...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className="bg-white dark:bg-gray-900 min-h-screen flex items-center justify-center transition-colors duration-300"
    >
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        {/* Title */}
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-[#fe5617] dark:text-[#ff784e]">
            Get in touch
          </h2>
        </div>
        ...
        <div className="flex flex-col items-center md:flex-row gap-[150px] justify-center">
          {/* Contact Info */}
          <div className="flex flex-col space-y-5 text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-200">
          ...
          >
            <h2 className="text-2xl font-bold text-[#fe5617] dark:text-[#ff784e] text-center">
              Send a Message
            </h2>
            <input
              type="text"
              ...
              required
              className="border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-md p-3"
            />
            <input
              type="email"
              name="email"
            ...
            <textarea
              ...
              onChange={handleChange}
              required
              className="border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-md p-3 h-32"
            ></textarea>
            <button
              type="submit"
